...
describe 'mecab', ->
  ...
  describe 'Using default instance', ->
    ...
    describe 'extractNouns(...)', ->
      it 'should be done', (done) ->
        inputString = '한글 형태소 분석기를 테스트'

        @mecab.extractNouns inputString, (err, result) =>
          should.not.exist err
          should.exist result
          done(err)

    describe 'extractNounMap(...)', ->
      it 'should be done', (done) ->
        inputString = '한글 형태소 분석기를 테스트'

        @mecab.extractNounMap inputString, (err, result) =>
          should.not.exist err
          should.exist result
          done(err)
  ...
  describe 'Building new instance with new MeCab', ->

    before ->
      @mecab = new mecab.MeCab
